...
namespace QuanLyChuoiCuaHangTrangSuc.StepSampleDataSetTableAdapters {
...
SELECT ID, FullName, Address1, Address2, City, StateRegion, PostalCode, PhoneNumber, WebSite, AnnualFee FROM Customer WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QuanLyChuoiCuaHangTrangSuc.Properties.Settings.Default.StepSampleConnectionString;
        }
